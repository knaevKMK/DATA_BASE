CREATE SCHEMA demo_table_relation;
USE demo_table_relation;
...
`name` VARCHAR(50) NOT NULL) AUTO_INCREMENT=101;
...
student_id INT(11),
CONSTRAINT fk_stundets_payments
FOREIGN KEY (student_id)
REFERENCES students (student_id)
);
