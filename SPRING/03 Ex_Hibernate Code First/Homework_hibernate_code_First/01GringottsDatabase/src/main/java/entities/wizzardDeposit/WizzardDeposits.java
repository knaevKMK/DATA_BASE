package entities.wizzardDeposit;
...
public class WizzardDeposits extends BaseEntite {
...
@Column (name="magic_wand_creator")
    ...
    public void setGetMagicWandSize(String getMagicWandSize) {
...
@Column(name = "deposit_start_sate")
...
@Column(name = "deposit_amount")
    ...
    @Column(name = "deposit_expiration_sate")
